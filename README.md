...
e.g.
./gradlew rest -Dpattern=jobs/seed.groovy -DbaseUrl=http://bukt-jenkins.equalexperts.com/ -Dusername=builduser -Dpassword=buildUserPassword
(note: ensure your baseUrl has a trailing slash)
```
